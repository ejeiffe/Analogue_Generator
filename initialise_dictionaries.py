...
functional_groups = {'H': '[H]', 'Me': 'C', 'Et': 'CC', 'n-Pr': 'CCC', 'i-Pr': 'C(C)(C)', 'n-Bu': 'CCCC', 'sec-Bu': 'C(C)(CC)', 'i-Bu': 'CC(C)C', 't-Bu': 'C(C)(C)(C)',
                    ...
                    'Ph': 'C1=CC=CC=C1', 'Bn': 'C(C1=CC=CC=C1)', '1-Naphthyl': 'C1=C2C(C=CC=C2)=CC=C1', '2-Naphthyl': 'C1=CC=C2C(C=CC=C2)=C1',
                    '2-Py': 'C1=NC=CC=C1', '3-Py': 'C1=CN=CC=C1', '4-Py': 'C1=CC=NC=C1',
                    '2-Pyrrole': 'C1=CC=CN1', '3-Pyrrole': 'C1=CNC=C1', '2-Furan': 'C1=CC=CO1', '3-Furan': 'C1=COC=C1', '2-Thiophene': 'C1=CC=CS1', '3-Thiophene': 'C1=CSC=C1',
                    'N-Imidazole': 'N1C=NC=C1','2-(1H-Imidazole)':'C1=NC=CN1','4-(1H-Imidazole)': 'C1=CNC=N1', '5-(1H-Imidazole)': 'C1=CN=CN1', '2-(N-Me-Imidazole)':'C1=N(C)C=CN1','4-(N-Me-Imidazole)': 'C1=CN(C)C=N1', '5-(N-Me-Imidazole)': 'C1=CN(C)=CN1'}
